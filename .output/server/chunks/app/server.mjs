import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, defineComponent, h, onUnmounted, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, Fragment, mergeProps, createApp, effectScope, reactive, shallowRef, isRef, useSSRContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isReadonly, Text, isShallow, isReactive, toRaw, withCtx } from 'vue';
...
import { ensureAdminApp, VueFireAuthServer, VueFireAppCheckServer } from 'vuefire/server';
import { deleteApp, initializeApp } from 'firebase/app';
import { createConsola as createConsola$1 } from 'consola/core';
import { LRUCache } from '@posva/lru-cache';
import { prodErrorMap, signInWithCustomToken } from 'firebase/auth';
import { _VueFireAuthInit, VueFire, useSSRInitialState } from 'vuefire';
import { getAuth } from 'firebase-admin/auth';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const payload_plugin_e0k4tW9bdI = definePayloadPlugin(() => {
...
const _routes = [
  {
    name: "docs-changelog___en",
    path: "/docs/changelog",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/changelog--5Tg00Vp.mjs').then((m) => m.default || m)
  },
  {
    name: "docs-changelog___de",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-Ex_Ma53v.mjs').then((m) => m.default || m)
  },
  {
    name: "index___de",
    path: "/de",
  ...
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "login___en",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/login",
    meta: __nuxt_page_meta$1 || {},
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/index-Tu1euiTG.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "login___de",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/de/login",
    meta: __nuxt_page_meta$1 || {},
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/index-Tu1euiTG.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-mV-AJEo_.mjs').then((m) => m.default || m)
  },
  {
    name: "logout___de",
    path: "/de/logout",
  ...
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "signup___en",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/signup",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index-xUvGtOui.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "signup___de",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/de/signup",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index-xUvGtOui.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/profile-kiL74PrE.mjs').then((m) => m.default || m)
  },
  {
...
const authentication_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
  {
    return;
  }
});
...
const LazyInputField = defineAsyncComponent(() => import('./_nuxt/InputField-ebNajqFe.mjs').then((r) => r.default));
const LazyPasswordField = defineAsyncComponent(() => import('./_nuxt/PasswordField-7MR2Hvww.mjs').then((r) => r.default));
const lazyGlobalComponents = [
  ["InputField", LazyInputField],
  ["PasswordField", LazyPasswordField]
];
...
const plugin_server_VRwXoZVCSq = /* @__PURE__ */ defineNuxtPlugin(() => {
  var _a;
  const event = useRequestEvent();
  const { vuefire } = /* @__PURE__ */ useRuntimeConfig();
  const firebaseAdminApp = ensureAdminApp((_a = vuefire == null ? void 0 : vuefire.admin) == null ? void 0 : _a.options);
...
const plugin_authenticate_user_server_MiwbozmGZf = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a;
  let __temp, __restore;
  const event = useRequestEvent();
  const firebaseApp = nuxtApp.$firebaseApp;
  ...
  const uid = decodedToken == null ? void 0 : decodedToken.uid;
  if (uid) {
    if (((_a = auth.currentUser) == null ? void 0 : _a.uid) !== uid) {
      const customToken = ([__temp, __restore] = executeAsync(() => adminAuth.createCustomToken(uid).catch((err) => {
        nuxtVueFireConsola.error("Error creating custom token", err);
        return null;
      })), __temp = await __temp, __restore(), __temp);
      if (customToken) {
        nuxtVueFireConsola.debug("Signing in with custom token");
        [__temp, __restore] = executeAsync(() => signInWithCustomToken(auth, customToken)), await __temp, __restore();
      }
    }
...
const vuefire_plugin_8cq4FnzXKb = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const firebaseApp = nuxtApp.$firebaseApp;
...
const plugin_server_alN9fDGiXy = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const firebaseApp = nuxtApp.$firebaseApp;
...
const resource$1 = {
  "APP_NAME": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "APP_NAME" } },
  "First name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "First name" } },
  "Last name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Last name" } },
  "E-Mail": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "E-Mail" } },
  ...
  "Cyberpunk": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cyberpunk" } },
  "Events": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Events" } },
  "Please Login": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Please Login" } },
  "Login": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Login" } },
  "Logging you out": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Logging you out" } },
  "Email": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Email" } },
  "auth/invalid-credential": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Invalid credentials.\nPlease check your email and your password." } },
  "auth/invalid-email": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Email is not valid." } },
  "auth/missing-password": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Please type in your password." } },
  "Or continue with": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Or continue with" } },
  "Not yet signed up?": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Not yet signed up?" } },
  "Sign Up": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Sign Up" } },
  "auth/redirect-failed": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Redirect to Google failed. Please try again." } },
  "Sign up": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Sign up" } },
  "Contains alphanumerical character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Contains alphanumerical character" } },
  "Contains special character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Contains special character" } },
  "Contains uppercase character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Contains uppercase character" } },
  "Is at least 8 characters long": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Is at least 8 characters long" } },
  "Retype Password": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Retype Password" } },
  "Passwords must match": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Passwords must match" } },
  "Already have an account?": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Already have an account?" } },
  "auth/email-already-in-use": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Email is already signed up. Please use the login." } }
};
const resource = {
  "APP_NAME": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "APP_NAME" } },
  "First name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Vorname" } },
  "Last name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Nachname" } },
  "E-Mail": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "E-Mail" } },
  ...
  "Cyberpunk": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "CyberPunk" } },
  "Events": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Veranstaltungen" } },
  "Please Login": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Anmeldung erforderlich" } },
  "Login": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Anmelden" } },
  "Logging you out": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Abmeldung erfolgt" } },
  "Email": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "E-Mail" } },
  "auth/invalid-credential": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ungültige Anmeldedaten.\nBitte prüfe Deine E-Mail und Dein Passwort." } },
  "auth/invalid-email": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Diese E-Mail ist nicht korrekt." } },
  "auth/missing-password": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Bitte gib Dein Passwort ein." } },
  "Or continue with": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Oder benutze" } },
  "Not yet signed up?": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Hast Du kein Account?" } },
  "Sign Up": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Registrieren" } },
  "auth/redirect-failed": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Weiterleitung zu Google hat nicht funktioniert. Bitte versuche es erneut." } },
  "Sign up": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Registrieren" } },
  "Contains alphanumerical character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enthält ein alphanumerisches Zeichen" } },
  "Contains special character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enthält ein Sonderzeichen" } },
  "Contains uppercase character": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enthält ein Grossbuchstabe" } },
  "Is at least 8 characters long": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Ist mindestens 8 Zeichen lang" } },
  "Retype Password": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Passwort wiederholen" } },
  "Passwords must match": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Passwörter müssen übereinstimmmen" } },
  "Already have an account?": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Hast Du bereits einen Account?" } },
  "auth/email-already-in-use": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Diese E-Mail ist bereits in Verwendung. Bitte melde Dich an." } }
};
const localeCodes = [
  "en",
  "de"
...
const localeMessages = {
  ...
  "de": [{ key: "../locales/de.json", load: () => Promise.resolve(resource), cache: true }]
};
const vueI18nConfigs = [
  () => import(
    './_nuxt/i18n.config-iD5ZCRZD.mjs'
...
const plugins = [
  ...
  plugin_authenticate_user_server_MiwbozmGZf,
  vuefire_plugin_8cq4FnzXKb,
  plugin_server_alN9fDGiXy,
  composition_sLxaNGmlSL,
  i18n_yfWm7jX06p
];
const layouts = {
  auth: () => import('./_nuxt/auth-TXJXCvNC.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default--ctjaWob.mjs').then((m) => m.default || m)
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="${ssrRenderClass([{ "hidden": !unref(loading) }, "loading-screen"])}"><div class="center"><div class="loader"></div><p class="h1">${ssrInterpolate(_ctx.$t("Getting ready..."))}</p></div></div><!--]-->`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-cKNYANN8.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-QRe54XKW.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-QTmwo49U.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useI18n as a, useLocalePath as b, createError as c, useRoute as d, entry$1 as default, useNuxtApp as e, useRouter as f, useSwitchLocalePath as g, hasProtocol as h, parseQuery$1 as i, joinURL as j, nuxtLinkDefaults as k, useRuntimeConfig as l, withoutTrailingSlash$1 as m, navigateTo as n, parseURL as p, useHead as u, withTrailingSlash$1 as w };
